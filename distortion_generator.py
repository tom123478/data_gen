...
def _apply_func_distortion(image, vertical, horizontal, max_offset, func):
    """
...
def sin(image, vertical=False, horizontal=False):
    ...
    return _apply_func_distortion(image, vertical, horizontal, max_offset, (lambda x: int(math.sin(math.radians(x)) * max_offset)))
...
def cos(image, vertical=False, horizontal=False):
    ...
    return _apply_func_distortion(image, vertical, horizontal, max_offset, (lambda x: int(math.cos(math.radians(x)) * max_offset)))
...
def random(image, vertical=False, horizontal=False):
    ...
    return _apply_func_distortion(image, vertical, horizontal, max_offset, (lambda x: rnd.randint(0, max_offset)))